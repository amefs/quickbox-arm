          ...
          <li>
            <div id="noticePanel" class="btn-group">
              <button class="btn" data-toggle="dropdown">
                <i class="fa fa-menu"></i> QuickBox ARM Menu <span class="caret"></span>
              </button>
                        ...
                        <li class="list-group-item">
                          <div class="row">
                            <div class="col-xs-12">
                              ...
                              <small><a href="https://github.com/amefs/quickbox-arm/blob/master/README.md" target="_blank">README.md</a></small>
                              <small><a href="https://github.com/amefs/quickbox-arm/blob/master/CHANGELOG.md#changelog-<?php echo $version; ?>" target="_blank">CHANGELOG</a></small>
                            </div>
                          </div>
                        </li>
